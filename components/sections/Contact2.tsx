						...
						<div className="col-lg-5 d-flex flex-column ps-lg-8">
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">+91-9764265386</h6>
								</div>
								<a href="tel:+91-9764265386" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">rahul.shirode123@gmail.com</h6>
								</div>
								<a href="mailto:rahul.shirode123@gmail.com" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">RahulShirode</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">411 021, Pune, MH, India</h6>
								</div>
